const params = {
  btnClassName: "header__art-navbar__btn",
  dropClassName: "header__art-navbar__drop",
...
Array.prototype.forEach.call(
  document.querySelectorAll('.header__art-navbar__genre'),
  (artNavbar) => new SimpleBar(artNavbar, {
    autoHide: false,
    classNames: {
